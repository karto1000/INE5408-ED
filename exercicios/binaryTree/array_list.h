...
#include <stdexcept>
//! Creating a namespace for my ArrayList definitons
namespace structures {
//! Class ArrayList
/*!
	Here are defined all the methods to the structure list implemented
	using array
*/
template<typename T>
class ArrayList {
//! Public methods and variables declaration
 public:
	...
	//! find a data in the array list
	std::size_t find(const T&) const;
	//! Return the actual size
	std::size_t size() const;
	//! Return the maximun size
	std::size_t max_size() const;
	//! return a value by the index
...
//! private methods and variables declaration
 private:
	T* contents; /*!< Pointer that defines the start of my list */
	std::size_t size_; /*< variable that defines my current size */
